...
- 🐞 修复 Avatar 的 `size` 属性为 `20` 时，图标不能垂直居中的问题。[#13408](https://github.com/ant-design/ant-design/issues/13408)
- 🐞 修复 Input 在设置 less 变量 `@border-width-base` 时的边框为你。[#13413](https://github.com/ant-design/ant-design/issues/13413) [@morenyang](https://github.com/morenyang)
